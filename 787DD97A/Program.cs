...
arrayflats[0] = new Flats("", 2, "Современное жилье", 22, "", 20, 58.7, 11, true, 11, 21300000, "Эконом");

arrayflats[1] = new Flats("", 2, "Современное жилье", 22, "", 19, 57.2, 9, true, 11, 22500000, "Эконом");

arrayflats[2] = new Flats("", 2, "Современное жилье", 17, "", 15, 58.6, 14, true, 10, 21400000, "Эконом");
